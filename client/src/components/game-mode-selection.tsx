    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground mb-12 text-lg">
          Select a game mode and match 3 cards to win!
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4 text-pink-400">Romance Mode</h3>
              <p className="text-muted-foreground mb-6">A playful challenge with romantic themes</p>
          ...
          >
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4 text-purple-400">Spicy Mode</h3>
              <p className="text-muted-foreground mb-6">A more daring and exciting challenge</p>
              <div className="flex justify-center space-x-2 mb-6">
